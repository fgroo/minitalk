...
int	main(void)
{
	...
	if (sigaction(SIGUSR1, &sa, NULL) == -1)
		return (ft_write_u(2, (unsigned char *)"SERVER: SIGUSR1", 15), 1);
	if (sigaction(SIGUSR2, &sa, NULL) == -1)
		return (ft_write_u(2, (unsigned char *)"SERVER: SIGUSR2", 15), 1);
	if (sigaction(SIGINT, &sa, NULL) == -1)
		return (ft_write_u(2, (unsigned char *)"SERVER: SIGINT", 14), 1);
